...
export const TemplateWorkplaceAirDocument = React.forwardRef<HTMLDivElement, { data: any }>(
  ({ data }, ref) => {
          ...
          <main className="text-[9px]">
            ...
            {regulation === 'permenaker_a' && (
                <table className="w-1/2 border-collapse border border-black mt-2">
                    ...
                    <tr><td className="border border-black p-1 w-1/3">Temperature</td><td className="border border-black p-1 w-px">:</td><td className="border border-black p-1">{sampleInfo.temperature || '-'} °C</td></tr>
...
TemplateWorkplaceAirDocument.displayName = 'TemplateWorkplaceAirDocument';
