...
import { Wind, Droplets, Biohazard, FileSearch } from "lucide-react"; // icon diganti biar lebih sesuai
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            <ServiceCard
              ...
              description="Ambient Air Monitoring, Mobile Source Emission, Stationary Source Emission Monitoring."
            />
            <ServiceCard
              icon={<Droplets className="size-6" />}
              title="Water Quality Testing"
              description="Wastewater Monitoring, Clean Water and Drinking Water Monitoring, Surface Water Monitoring (Rivers, Lakes, Coastal Waters)."
            />
            <ServiceCard
              icon={<Biohazard className="size-6" />}
              title="Hazardous Waste (B3) Testing"
              description="TCLP, LC50, LD50, Acute/Subchronic/Chronic Toxicity Testing, and other hazardous waste testing."
            />
            <ServiceCard
              icon={<FileSearch className="size-6" />}
              title="Environmental Consulting"
              description="AMDAL, UKL-UPL, PERTEK, RINTEK, and other environmental documentation consulting services."
            />
          </div>
        </div>
      </section>
